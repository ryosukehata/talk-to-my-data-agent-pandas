...
export const createInitialState = (): AppStateData => {
  return {
    ...
    enableChartGeneration:
      getStorageItem(STORAGE_KEYS.ENABLE_CHART_GENERATION) !== "false", // Enable by default
    enableBusinessInsights:
      getStorageItem(STORAGE_KEYS.ENABLE_BUSINESS_INSIGHTS) !== "false", // Enable by default
    ...
    expandGraphsInsightsDefaultOpen:
      getStorageItem(STORAGE_KEYS.EXPAND_GRAPHS_INSIGHTS_DEFAULT_OPEN) ===
      "true",
  };
};
