...
def get_configuration(
    ...
    default_model = configured_model(resolved_env, DEFAULT_DEPLOYED_MODEL)
    deployment_id = (
        resolved_env.get("LLM_DEPLOYMENT_ID")
        or resolved_env.get("TEXTGEN_DEPLOYMENT_ID")
        or "${TEXTGEN_DEPLOYMENT_ID}"
    )
